...
**Goal**: Create interactive dashboards with `shiny`.
...
```{r}
holidays <- c("Thanksgiving", "Halloween")
fall <- list(groceries = groceries, holidays = holidays)
fall
```
