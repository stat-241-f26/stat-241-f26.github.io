...
## First goal: accept the invite to `stat-241-f26`


* You should have received an email from me / GitHub on Sunday.
...
(6) Head over to the `#q-and-a` channel and paste in the contents as a reply to the `reprex` practice message.  A text box will pop-up and select "Apply". 
...
* Learn to ask good coding questions!

* Hone our data wrangling skills

* P-set 1 due on Tuesday 9/22 @ noon
